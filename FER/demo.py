...
def main():
    ...
    out_video = '/home/phatngy/Desktop/output.avi'
    out_vid = cv2.VideoWriter(out_video, cv2.VideoWriter_fourcc('M', 'J', 'P', 'G'), 25, (640, 480))
    ...
    while cam.isOpened():
        ...
        try:
            ...
            # frm = cv2.resize(frm, (480, 640))
            out_vid.write(frm)
            if pred == 'Happy':
                cv2.imwrite('demo_happy.jpg', frm)
            elif pred == 'Neutral':
                cv2.imwrite('demo_neutral.jpg', frm)
